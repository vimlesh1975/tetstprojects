...
mos.onConnection((mosDevice) => {
	...
	mosDevice.onReadyToAir(async (Action)=> {
	...
	mosDevice.onROInsertStories(async (Action, Stories) => {
	...
	mosDevice.onROMoveStories(async (Action, Stories)=> {
	...
	mosDevice.onRODeleteStories(async (Action, Stories)=> {
