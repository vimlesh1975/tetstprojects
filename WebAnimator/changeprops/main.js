setTimeout(() => {
    ...
    element.set({ text: 'My name is Vmlesh Kumar' });
    ...
    changePropOfObject('f1', 'left', canvas.getObjects().find((item) => item.id === 'f1').left + 200)
    changePropOfObject('f1', 'top', canvas.getObjects().find((item) => item.id === 'f1').top + 200)
