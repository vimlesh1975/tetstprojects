...
class ConnectionConfig {
    constructor(init) {
        ...
        if (typeof init !== 'object')
            throw new Error('Config object is not an object');
        if (init.mosID === undefined)
            throw new Error('Config argument "mosID" missing');
        if (init.acceptsConnections === undefined)
            throw new Error('Config argument "acceptsConnections" missing');
        if (init.profiles === undefined)
            throw new Error('Config argument "profiles" missing');
        /* tslint:enable */
